...
class ThreadRanker(object):
    ...
    def get_best_thread(self, question, tag_name):
		...
		cos_sim = cosine_similarity(question_vec,thread_embeddings)
		
		'''sort cos_sim and get list of their indices'''
		sorted_indices = np.argsort(cos_sim[0])
		
		reversed_sorted_indices = reversed(sorted_indices)
		best_thread = reversed_sorted_indices[0]	
